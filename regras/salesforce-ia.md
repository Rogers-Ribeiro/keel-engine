...
Prefixo `SFAI`. Regras confirmadas nas transcrições a 2026-09-21. Síntese de origem: [salesforce-ia](https://github.com/Rogers-Ribeiro/keel/blob/main/conhecimento/salesforce-ia.md). Decisões pendentes: [revisão](_revisao/salesforce-ia.md).

## Segurança do prompt e da resposta
...
**Fonte:** [Agentforce §2, aula 5](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/05-secure-data-retrieval-and-grounding.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/02-einstein-trust-layer.md)
**Cursos:** 1
...
**Fonte:** [Agentforce §2, aula 6](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/06-what-is-data-masking.md) · [Agentforce §2, aula 9](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/09-what-is-response-journey-toxicity-detection-data-unmasking-feedback-audit.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/02-einstein-trust-layer.md)
**Cursos:** 1
...
**Fonte:** [Agentforce §2, aula 7](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/07-what-is-prompt-defense-and-prompt-injection.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/02-einstein-trust-layer.md)
**Cursos:** 1
...
**Fonte:** [Agentforce §2, aula 8](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/08-zero-data-retention-policy-in-salesforce-einstein-trust-layer.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/02-einstein-trust-layer.md)
**Cursos:** 1
...
**Fonte:** [Agentforce §2, aula 9](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/09-what-is-response-journey-toxicity-detection-data-unmasking-feedback-audit.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/02-einstein-trust-layer.md)
**Cursos:** 1
...
**Fonte:** [Agentforce §2, aula 9](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/09-what-is-response-journey-toxicity-detection-data-unmasking-feedback-audit.md) · [Agentforce §13, aula 75](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/75-einstein-audit-analytics-monitoring-setup.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/02-einstein-trust-layer.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/13-new-topics-based-on-exam-objective-change.md)
**Cursos:** 1
...
**Fonte:** [Agentforce §5, aula 34](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/34-how-to-create-a-new-topic-in-einstein-copilot.md) · [Agentforce §5, aula 31](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/31-overview-of-einstein-copilot.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/05-agentforce-concepts-30.md)
**Cursos:** 1
...
**Fonte:** [Agentforce §5, aula 34](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/34-how-to-create-a-new-topic-in-einstein-copilot.md) · [Agentforce §12, aula 64](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/64-why-is-testing-agents-so-important.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/05-agentforce-concepts-30.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/12-testing-center.md)
**Cursos:** 1
...
**Fonte:** [Agentforce §13, aula 76](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/76-hybrid-search-vs-vector-search.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/13-new-topics-based-on-exam-objective-change.md)
**Cursos:** 1
...
**Fonte:** [Agentforce §13, aula 70](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/70-salesforce-agentforce-how-to-use-individual-and-ensemble-retrievers-for-better.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/13-new-topics-based-on-exam-objective-change.md)
**Cursos:** 1
...
**Fonte:** [Agentforce §13, aula 72](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/72-creating-a-flex-prompt-template-to-process-and-read-images.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/13-new-topics-based-on-exam-objective-change.md)
**Cursos:** 1
...
**Fonte:** [Agentforce §12, aula 67](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/67-demo-of-testing-center-part-2.md) · [Agentforce §12, aula 65](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/transcricoes/65-agentforce-testing-center-overview.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/salesforce-ai-specialist-certification-course/notas/12-testing-center.md)
**Cursos:** 1
