...
Prefixo `FIL`. Regras confirmadas nas transcrições a 2026-09-17. Síntese de origem: [filas-e-concorrencia](https://github.com/Rogers-Ribeiro/keel/blob/main/conhecimento/filas-e-concorrencia.md). Decisões pendentes: [revisão](_revisao/filas-e-concorrencia.md).

## Trabalho fora do caminho do pedido
...
**Fonte:** [FastAPI §18, aula 102](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/102-background-tasks.md) · [Redis §21, aula 175](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/175-use-case-of-streams.md) · [nota FastAPI](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/notas/18-send-mail.md) · [nota Redis](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/21-service-communication-with-streams.md)
**Cursos:** 2
...
**Fonte:** [FastAPI §24, aula 124](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/124-background-worker.md) · [FastAPI §24, aula 125](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/125-task-function.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/notas/24-celery.md)
**Cursos:** 1
...
**Fonte:** [FastAPI §24, aula 124](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/124-background-worker.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/notas/24-celery.md)
**Cursos:** 1
...
**Fonte:** [Redis §2, aula 16](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/016-again-why-do-these-commands-exist.md) · [nota Redis §2](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/02-commands-for-adding-and-querying-data.md) · [nota Redis §16](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/16-more-practice-with-the-e-commerce-app.md)
**Cursos:** 1
...
**Fonte:** [Redis §18, aula 137](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/137-implementing-withlock.md) · [Redis §18, aula 140](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/140-automatically-expiring-locks.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/18-understanding-and-solving-concurrency-issues.md)
**Cursos:** 1
...
**Fonte:** [Redis §18, aula 142](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/142-solving-accidental-unlocks.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/18-understanding-and-solving-concurrency-issues.md)
**Cursos:** 1
...
**Fonte:** [Redis §21, aula 184](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/184-creating-and-inspecting-consumer-groups.md) · [Redis §21, aula 185](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/185-consumer-groups-in-action.md) · [Redis §21, aula 182](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/182-issues-with-standard-streams.md) · [Redis §21, aula 183](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/183-consumer-groups.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/21-service-communication-with-streams.md)
**Cursos:** 1
...
**Fonte:** [Redis §21, aula 186](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/186-claiming-expired-messages.md) · [Redis §21, aula 183](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/183-consumer-groups.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/21-service-communication-with-streams.md)
**Cursos:** 1
...
**Fonte:** [SQLAlchemy §6, aula 30](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/transcricoes/30-migrating-to-asynchronous-mode.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/notas/06-advanced-topics.md)
**Cursos:** 1
