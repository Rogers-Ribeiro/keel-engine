...
Prefixo `DB`. Regras confirmadas nas transcrições a 2026-09-17. Síntese de origem: [persistencia](https://github.com/Rogers-Ribeiro/keel/blob/main/conhecimento/persistencia.md). Decisões pendentes: [revisão](_revisao/persistencia.md). A secção «Isolamento entre tenants» é a excepção: não sai de curso nenhum, sai da referência [postgres-multitenancy](../docs/postgres-multitenancy.md).
...
**Fonte:** [FastAPI §7, aula 35](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/035-sql-query-parameters.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/notas/07-sql-database.md) · [nota SQLAlchemy §4](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/notas/04-querying-with-sqlalchemy-orm.md)
**Cursos:** 2
...
**Fonte:** [FastAPI §7, aula 34](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/034-update-row.md) · [SQLAlchemy §4, aula 18](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/transcricoes/18-insert-queries-using-the-orm.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/notas/05-modifying-data-with-orm.md)
**Cursos:** 2
...
**Fonte:** [SQLAlchemy §4, aula 24](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/transcricoes/24-advanced-select-queries-with-joins-with-sqlalchemy-orm.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/notas/04-querying-with-sqlalchemy-orm.md)
**Cursos:** 1
...
**Fonte:** [SQLAlchemy §3, aula 13](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/transcricoes/13-using-sqlalchemy-to-create-tables-in-the-database.md) · [FastAPI §15, aula 85](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/085-setup.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/notas/03-alembic-for-database-management.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/notas/15-alembic-database-migrations.md)
**Cursos:** 2
...
**Fonte:** [SQLAlchemy §3, aula 16](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/transcricoes/16-modifying-the-database-structure-with-alembic.md) · [FastAPI §15, aula 87](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/087-autogenerate-revision.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/notas/03-alembic-for-database-management.md)
**Cursos:** 2
...
**Fonte:** [SQLAlchemy §3, aula 14](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/transcricoes/14-getting-started-with-alembic.md) · [FastAPI §15, aula 87](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/087-autogenerate-revision.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/notas/03-alembic-for-database-management.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/notas/15-alembic-database-migrations.md)
**Cursos:** 2
...
**Fonte:** [SQLAlchemy §3, aula 16](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/transcricoes/16-modifying-the-database-structure-with-alembic.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/notas/03-alembic-for-database-management.md)
**Cursos:** 1
...
**Fonte:** [FastAPI §10, aula 53](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/053-environment-variable.md) · [SQLAlchemy §3, aula 14](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/transcricoes/14-getting-started-with-alembic.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/notas/10-postgresql.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/notas/03-alembic-for-database-management.md)
**Cursos:** 2
...
**Fonte:** [FastAPI §10, aula 54](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/054-async-session.md) · [SQLAlchemy §6, aula 30](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/transcricoes/30-migrating-to-asynchronous-mode.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/notas/10-postgresql.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/notas/06-advanced-topics.md)
**Cursos:** 2
...
**Fonte:** [FastAPI §8, aula 43](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/043-dependency-injection.md) · [SQLAlchemy §1, aula 5](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/transcricoes/05-establishing-database-connection.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/notas/08-sqlmodel.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/sqlalchemy-alembic-bootcamp/notas/01-introduction-and-setup.md)
**Cursos:** 2
...
**Fonte:** [FastAPI §11, aula 62](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/062-password-hash.md) · [FastAPI §11, aula 59](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/transcricoes/059-overview.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/fastapi-guide/notas/11-register-user.md)
**Cursos:** 1
...
**Fonte:** [Redis §7, aula 41](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/041-reducing-the-design-to-queries.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/07-powerful-design-patterns.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/03-e-commerce-app-setup.md)
**Cursos:** 1
...
**Fonte:** [Redis §3, aula 27](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/027-key-naming-methodology.md) · [Redis §3, aula 29](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/029-better-key-generation.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/03-e-commerce-app-setup.md)
**Cursos:** 1
...
**Fonte:** [Redis §2, aula 10](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/010-use-case-of-expiration-options.md) · [Redis §3, aula 28](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/028-adding-page-caching.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/02-commands-for-adding-and-querying-data.md)
**Cursos:** 1
...
**Fonte:** [Redis §2, aula 16](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/016-again-why-do-these-commands-exist.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/02-commands-for-adding-and-querying-data.md)
**Cursos:** 1
...
**Fonte:** [Redis §18, aula 140](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/140-automatically-expiring-locks.md) · [Redis §18, aula 143](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/transcricoes/143-adding-an-unlock-script.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/redis-the-complete-developers-guide-p/notas/18-understanding-and-solving-concurrency-issues.md)
**Cursos:** 1
