...
Prefixo `IAP`. Regras confirmadas nas transcrições a 2026-09-17. Síntese de origem: [producao-ia](https://github.com/Rogers-Ribeiro/keel/blob/main/conhecimento/producao-ia.md). Decisões pendentes: [revisão](_revisao/producao-ia.md).
...
**Fonte:** [LangChain §12, aula 76](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/langchain/transcricoes/076-llm-applications-in-production.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/langchain/notas/12-let-s-talk-about-llm-applications-in-production.md) · [Claude Code §37, aula 339](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/formacao-desenvolvedor-ia-com-agentes-claude-code-e-codex/transcricoes/339-agentes-ia-x-workflow.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/formacao-desenvolvedor-ia-com-agentes-claude-code-e-codex/notas/37-fundamentos-da-ia-generativa.md)
**Cursos:** 2
...
**Fonte:** [Production Agents §3, aula 19](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/019-model-configuration-and-cost-optimization-strategies.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/03-langchain-foundations-a-deep-dive.md) · [Eng. IA §5, aula 43](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/formacao-engenheiro-de-ia-generativa-ia-na-pratica/transcricoes/043-tomada-de-decisao-com-ia.md) · [Claude Code §2, aula 13](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/formacao-desenvolvedor-ia-com-agentes-claude-code-e-codex/transcricoes/013-os-modelos-do-claude.md)
**Cursos:** 3
...
**Fonte:** [Production Agents §3, aula 5](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/005-the-langchain-ecosystem-overview.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/03-langchain-foundations-a-deep-dive.md) · [referência](../docs/langchain-formatos.md)
**Cursos:** 1
...
**Fonte:** [Production Agents §3, aula 19](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/019-model-configuration-and-cost-optimization-strategies.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/03-langchain-foundations-a-deep-dive.md)
**Cursos:** 1
...
**Fonte:** [LangChain §2, aula 10](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/langchain/transcricoes/010-building-a-langchain-chain-to-summarize-text.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/langchain/notas/02-the-gist-of-langchain-get-started-by-with-your-hello-world-c.md) · [Production Agents §3, aula 19](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/019-model-configuration-and-cost-optimization-strategies.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/03-langchain-foundations-a-deep-dive.md) · [decisão D-AV04](../docs/decisoes/g6-avaliacao-e-prompts.md)
**Cursos:** 2
...
**Fonte:** [Production Agents §3, aula 26](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/026-hands-on-why-output-parsers-and-structured-outputs.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/03-langchain-foundations-a-deep-dive.md) · [LangChain §8, aula 41](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/langchain/transcricoes/041-theory-understanding-function-calling-for-llms.md) · [referência](../docs/langchain-formatos.md)
**Cursos:** 2
...
**Fonte:** [Production Agents §7, aula 89](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/089-langgraph-and-its-pillars-overview.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/07-langgraph-a-full-deep-dive.md)
**Cursos:** 1
...
**Fonte:** [Production Agents §7, aula 100](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/100-hands-on-cycles-and-loops-self-correcting-code-writer.md) · [Production Agents §7, aula 107](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/107-langgraph-summary-and-key-takeaways.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/07-langgraph-a-full-deep-dive.md)
**Cursos:** 1
...
**Fonte:** [Production Agents §7, aula 105](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/105-hands-on-checkpointing-deep-dive.md) · [Production Agents §7, aula 107](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/107-langgraph-summary-and-key-takeaways.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/07-langgraph-a-full-deep-dive.md) · [referência](../docs/langchain-formatos.md)
**Cursos:** 1
...
**Fonte:** [Production Agents §7, aula 107](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/107-langgraph-summary-and-key-takeaways.md) · [Production Agents §7, aula 103](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/103-hands-on-human-input-interrupt-for-approval.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/07-langgraph-a-full-deep-dive.md) · [referência](../docs/langchain-formatos.md)
**Cursos:** 1
...
**Fonte:** [Cientista §38, aula 249](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/cientista-de-dados/transcricoes/249-criando-mcp-server-no-n8n.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/cientista-de-dados/notas/38-automacao-com-mcp-e-n8n.md)
**Cursos:** 1
...
**Fonte:** [Production Agents §6, aula 67](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/067-hands-on-rag-with-fallback.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/06-rag-and-memory-a-comprehensive-dive.md)
**Cursos:** 1
...
**Fonte:** [Production Agents §6, aula 66](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/066-hands-on-rag-with-resources.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/06-rag-and-memory-a-comprehensive-dive.md) · [RAG Bootcamp §22, aula 113](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/ultimate-rag-bootcamp-using-langchainlanggraph-langsmith/transcricoes/113-advance-cag-implementation-with-langgraph.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/ultimate-rag-bootcamp-using-langchainlanggraph-langsmith/notas/22-cache-rag-with-langgraph.md)
**Cursos:** 2
...
**Fonte:** [Production Agents §6, aula 79](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/079-hands-on-message-trimming.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/06-rag-and-memory-a-comprehensive-dive.md)
**Cursos:** 1
...
**Fonte:** [Production Agents §9, aula 141](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/141-hands-on-fallback-chain.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/09-production-deployment-deploying-ai-agents.md)
**Cursos:** 1
...
**Fonte:** [Production Agents §9, aula 125](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/transcricoes/125-introduction-to-observability-and-benefits-deep-dive.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/production-ai-agents/notas/09-production-deployment-deploying-ai-agents.md) · [Eng. IA §27, aula 255](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/formacao-engenheiro-de-ia-generativa-ia-na-pratica/transcricoes/255-adicionando-langsmith-ao-projeto.md) · [referência](../docs/langchain-formatos.md)
**Cursos:** 2
...
**Fonte:** [LangChain §12, aula 76](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/langchain/transcricoes/076-llm-applications-in-production.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/langchain/notas/12-let-s-talk-about-llm-applications-in-production.md)
**Cursos:** 1
...
**Fonte:** [LangChain §2, aula 8](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/langchain/transcricoes/008-project-setup.md) · [nota](https://github.com/Rogers-Ribeiro/keel/blob/main/cursos/langchain/notas/02-the-gist-of-langchain-get-started-by-with-your-hello-world-c.md)
**Cursos:** 1
